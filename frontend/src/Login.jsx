      ...
      <div className="card animate-up" style={{ width: '100%', maxWidth: '440px', padding: '3rem' }}>
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          <img 
            ...
            alt="LPU Logo" 
            style={{ height: '60px', marginBottom: '1.5rem', filter: theme === 'dark' ? 'brightness(0) invert(1)' : 'none' }} 
          />
          <h1 style={{ fontSize: '2rem', marginBottom: '0.5rem', fontWeight: '800' }}>HostelConnect</h1>
